...
| Name | Backronym | Hook |
|------|-----------|------|
| **OTTO** | **O**rchestrated **T**ask & **T**ooling **O**perator | Palindrome → visually mirrors the *loop* theme. Reads as "auto." Friendly. |
| **ECHO** | **E**ngineered **C**oding **H**elper & **O**rchestrator | An echo loops. Implies relay/routing through kiro-cli + Langflow. |
| **KIRA** | **K**iro-**I**ntegrated **R**outing **A**ssistant | Direct play on `kiro-cli`. Feminine counterpart to OSCAR phonetically. |
| **MILO** | **M**ulti-step **I**terative **L**ocal **O**perator | "Iterative" + "Local" hits two product pillars. |
| **ARLO** | **A**utomated **R**outing & **L**ocal **O**perator | Slightly more "ops"-flavored than MILO. |
| **REMI** | **R**outed **E**xecution & **M**ulti-step **I**teration | Gender-neutral. "Routed" + "Iteration" = the two architectural verbs. |

---

## Round 2 — Research / Investigation flavor

These lean into the *research worker*, *analysis*, and *knowledge* axes.

| Name | Backronym | Hook |
|------|-----------|------|
| **ADA** | **A**nalytical **D**iscovery **A**ssistant | Honors Ada Lovelace. Instant "this thing investigates and reasons." Heritage pick. |
| **SAGE** | **S**cholarly **A**gent **G**uiding **E**ngineers | "Sage" is a research synonym. The plain English meaning *is* the pitch. |
| **IRIS** | **I**nvestigative **R**esearch & **I**teration **S**ynthesizer | Greek messenger goddess (routing) + iris/aperture (observation). Double semantic hit. |
| **VERA** | **V**erification, **E**ngineering & **R**esearch **A**gent | "Vera" = truth (Latin/Slavic). On-brand for a citing/grounding system. |
| **DARWIN** | **D**iscovery, **A**nalysis & **R**esearch **W**orker for **I**ntelligent **N**avigation | Naturalist-in-the-field energy. Heavy cultural payload. Longer. |
| **MARLOW** | **M**ulti-**A**gent **R**esearch & **L**ocal **O**rchestration **W**orker | Detective vibe (Philip Marlowe). "Investigator at a desk" maps to local-laptop research worker. |

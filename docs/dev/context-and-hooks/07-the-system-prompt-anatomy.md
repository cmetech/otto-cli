...
If `.otto/workflow/SYSTEM.md` (project) or `~/.otto/agent/SYSTEM.md` (global) exists, its contents **completely replace** the default base prompt above. The tools list, guidelines, pi docs pointers — all gone. You own the entire base.
...
If `.otto/workflow/APPEND_SYSTEM.md` (project) or `~/.otto/agent/APPEND_SYSTEM.md` (global) exists, its contents are appended after the base prompt.
...
## /Users/you/.otto/workflow/agent/AGENTS.md

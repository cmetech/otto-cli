...
| Package | Purpose |
|---------|---------|
| `@otto/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, event types, utilities) |
| `@sinclair/typebox` | Schema definitions for tool parameters (`Type.Object`, `Type.String`, etc.) |
| `@otto/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@otto/pi-tui` | TUI components (`Text`, `Box`, `Container`, `SelectList`, etc.) |

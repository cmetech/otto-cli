...
- `~/.otto/agent/extensions/worktree/index.ts`
...
- `~/.otto/docs/extending-pi/11-custom-commands-user-facing-actions.md`
- `~/.otto/docs/extending-pi/09-extensionapi-what-you-can-do.md`
- `~/.otto/agent/extensions/worktree/index.ts`

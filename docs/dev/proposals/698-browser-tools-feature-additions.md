...
> Ref: [#698](https://github.com/cmetech/otto-cli/issues/698)
...
| **Storage location** | Session artifacts directory: `.otto/workflow/browser-state/<name>.json` |
...
- [ ] State files written to `.otto/workflow/browser-state/` and gitignored
...
| **Baseline management** | Save baselines to `.otto/workflow/browser-baselines/`; auto-name by URL + viewport |

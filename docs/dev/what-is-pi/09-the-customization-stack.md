...
**Placement:**
- `~/.otto/agent/extensions/` (global)
- `.otto/workflow/extensions/` (project-local)
...
**Placement:**
- `~/.otto/agent/prompts/` (global)
- `.otto/workflow/prompts/` (project-local)
...
**Placement:**
- `~/.otto/agent/themes/` (global)
- `.otto/workflow/themes/` (project-local)

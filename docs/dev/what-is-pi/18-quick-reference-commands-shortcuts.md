...
> **iTerm2 users:** Ctrl+Alt shortcuts (e.g., Ctrl+Alt+G for the OTTO dashboard) require Left Option Key set to "Esc+" in Profiles → Keys → General. The default "Normal" setting swallows the Alt modifier.

...
OTTO requires Node.js **v22 or later** and works best on an **LTS (even-numbered) release**. This guide shows how to pin Node 24 LTS using Homebrew.
...
- **Compatibility** — npm packages (including OTTO) test against LTS versions

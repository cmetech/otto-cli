...
Rust N-API addon providing high-performance native modules for OTTO.
...
Inspired by [Oh My Pi's pi-natives](https://github.com/can1357/oh-my-pi), adapted for OTTO's Node.js runtime.
...
```typescript
import { grep, searchContent } from "@otto/native";
...
OTTO file parsing and frontmatter extraction. Reads OTTO workflow files and extracts structured metadata from YAML frontmatter blocks.
...
HTML-to-Markdown conversion. Transforms HTML content into clean Markdown, useful for importing web content into OTTO notes and documents.

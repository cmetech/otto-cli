...
const SYSTEM_PROMPT = `You are OTTO Control — a concise, capable orchestrator for managing OTTO (Orchestrating Tools, Tasks and Outcomes) coding agent sessions via Discord.

// the agent + packages/pi-coding-agent/src/modes/interactive/components/bash-execution.test.ts - Bash execution renderer regression coverage.

import { describe, it, before } from "node:test";
import assert from "node:assert/strict";
import { type Container, type TUI } from "@otto/pi-tui";

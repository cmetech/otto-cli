...
//
// The canonical JSON copy of this palette lives at
// `src/resources/extensions/loop24/theme/loop24.json` for documentation
// purposes; the runtime registers from this object so the theme ships
// inside the TS rootDir without crossing package boundaries.

const loop24: ThemeJson = {
	name: "loop24",
	vars: {
		brandBlack: "#0C0C0C",
		brandWhite: "#FAFAFA",

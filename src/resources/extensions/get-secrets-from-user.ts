...
import type { ExtensionAPI, Theme } from "@otto/pi-coding-agent";
import { Editor, type EditorTheme, Key, matchesKey, Text, truncateToWidth, wrapTextWithAnsi } from "@otto/pi-tui";
...
// The implementation lives in env-utils.ts to avoid pulling @otto/pi-tui

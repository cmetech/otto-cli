...
import { buildPrEvidence } from "../workflow/pr-evidence.js";
...
export function formatMilestoneIssueBody(data: MilestoneData): string {
  ...
  lines.push("---");
  lines.push("*Auto-generated by GitHub Sync*");
...
export function formatSlicePRBody(data: SliceData): string {
  ...
  return buildPrEvidence({
    ...
    how: "Generated by GitHub Sync from the slice plan, task issues, and branch mapping.",
  }).body;
}
...
export function formatSwarmLanePRBody(data: SwarmLanePRData): string {
  ...
  return buildPrEvidence({
    ...
    how: "Generated by GitHub Sync swarm routines from lane evidence.",
  }).body;
}
...
export function formatSwarmReleaseChecklistBody(data: SwarmReleaseChecklistData): string {
  ...
  lines.push("---");
  lines.push("*Auto-generated by GitHub Sync swarm routines*");

/**
 * Shared UI design system for the workflow/interview TUI components.
 *
...
export interface UI {
	...
	editorTheme: import("@loop24/pi-tui").EditorTheme;
}
...
export function makeUI(theme: Theme, width: number): UI {
	...
	const editorTheme: import("@loop24/pi-tui").EditorTheme = {

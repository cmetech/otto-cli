...
//
// After any file write that changes .otto/workflow/ contents, all three must be
...
// invoke clearArtifacts() from db.js explicitly — do not add it back
// here.
 ...
 * or any operation that changes .otto/workflow/ contents on disk. Forgetting to clear

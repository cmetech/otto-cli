...
import { resolveWorkflowPathContract, resolveMilestoneFile } from "./paths.js";
...
export async function checkEngineHealth(
  ...
  try {
    if (isDbAvailable()) {
      const eventLogPath = join(basePath, ".otto/workflow", "event-log.jsonl");

 ...
 *
 * LEAF NODE: This file must have ZERO imports from any workflow module.
 * Only `node:` imports are permitted. All engine/policy interfaces
 * depend on these types; nothing here depends on internal modules.
 */
...
export interface EngineState {
  ...
  isComplete: boolean;
  /** Opaque engine-specific state — never narrowed to a workflow-specific type. */
  raw: unknown;
}

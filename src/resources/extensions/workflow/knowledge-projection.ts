// OTTO — KNOWLEDGE.md hybrid projection renderer (ADR-013 Stage 2b).
//
// Renders `.otto/workflow/KNOWLEDGE.md` as a hybrid file:
...
// section continue to round-trip through `/otto knowledge`.
//

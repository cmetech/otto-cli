...
7. Call `otto_summary_save` with `milestone_id: {{milestoneId}}`, `slice_id: {{sliceId}}`, `artifact_type: "RESEARCH"`, and full research markdown as `content`. The tool writes DB and disk.

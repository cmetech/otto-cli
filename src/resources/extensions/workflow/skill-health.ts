/**
 * Skill Health — Dashboard, Staleness, and Heal-Skill Integration (#599)
 *
 ...
 * This is the integrated version of glittercowboy's heal-skill concept.
 *
...
5. **If significant drift found**, write a heal suggestion to \`.otto/workflow/skill-review-queue.md\`:

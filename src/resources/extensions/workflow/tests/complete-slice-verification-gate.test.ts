...
function makeProject(): string {
  ...
  fs.mkdirSync(path.join(basePath, '.otto/workflow', 'milestones', 'M001', 'slices', 'S01', 'tasks'), { recursive: true });
  fs.writeFileSync(
    path.join(basePath, '.otto/workflow', 'milestones', 'M001', 'M001-ROADMAP.md'),

...
function setupRepo(): string {
  ...
  openDatabase(join(repo, ".otto/workflow", "otto.db"));
  return repo;
}
...
test("dispatch guard blocks when prior milestone has incomplete slices", (t) => {
  ...
  mkdirSync(join(repo, ".otto/workflow", "milestones", "M002"), { recursive: true });
  mkdirSync(join(repo, ".otto/workflow", "milestones", "M003"), { recursive: true });
  ...
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M002", "M002-ROADMAP.md"), "# M002\n");
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M003", "M003-ROADMAP.md"), "# M003\n");
...
test("dispatch guard skips prior DB parked or deferred milestones without marker files", (t) => {
  ...
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M001", "M001-ROADMAP.md"), "# M001\n");
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M002", "M002-ROADMAP.md"), "# M002\n");
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M003", "M003-ROADMAP.md"), "# M003\n");
...
test("dispatch guard ignores positionally-earlier reverse dependents for zero-dependency slices (#3720)", (t) => {
  ...
  mkdirSync(join(repo, ".otto/workflow", "milestones", "M015"), { recursive: true });
  ...
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M015", "M015-ROADMAP.md"), "# M015\n");
...
test("dispatch guard treats zero-dependency slices as independent when a milestone uses explicit deps (#3998)", (t) => {
  ...
  mkdirSync(join(repo, ".otto/workflow", "milestones", "M022"), { recursive: true });
  ...
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M022", "M022-ROADMAP.md"), "# M022\n");
...
test("dispatch guard does not skip prior milestone from SUMMARY projection when DB is not closed", (t) => {
  ...
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M001", "M001-ROADMAP.md"), "# M001\n");
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M001", "M001-SUMMARY.md"),
    "---\nstatus: complete\n---\n# M001 Summary\nDone.\n");
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M002", "M002-ROADMAP.md"), "# M002\n");
...
test("dispatch guard skips cross-milestone check when OTTO_MILESTONE_LOCK is set (#2797)", (t) => {
  const repo = setupRepo();
  t.after(() => {
  ...
  mkdirSync(join(repo, ".otto/workflow", "milestones", "M010"), { recursive: true });
  mkdirSync(join(repo, ".otto/workflow", "milestones", "M011"), { recursive: true });
  mkdirSync(join(repo, ".otto/workflow", "milestones", "M012"), { recursive: true });
  ...
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M010", "M010-ROADMAP.md"), "# M010\n");
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M011", "M011-ROADMAP.md"), "# M011\n");
  writeFileSync(join(repo, ".otto/workflow", "milestones", "M012", "M012-ROADMAP.md"), "# M012\n");
  ...
  process.env.OTTO_MILESTONE_LOCK = "M012";
  assert.equal(
    getPriorSliceCompletionBlocker(repo, "main", "execute-task", "M012/S01/T01"),
    null,
  );

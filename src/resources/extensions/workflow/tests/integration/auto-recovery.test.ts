  ...
  try {
    ...
    insertTask({
      ...
      planning: {
        ...
        inputs: ["src/resources/extensions/workflow/gsd-db.ts"],
    ...
    insertTask({
      ...
      planning: {
        ...
        estimate: "20m",
        files: ["src/resources/extensions/workflow/auto-recovery.ts"],
        verify: "node --test auto-recovery.test.ts",
        inputs: ["src/resources/extensions/workflow/auto-recovery.ts"],

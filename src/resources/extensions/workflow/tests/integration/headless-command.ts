 ...
 *
 * Usage:
 *   npx tsx src/resources/extensions/workflow/tests/integration/headless-command.ts
...
function createFixture(): string {
  ...
  // Write fixture files
  writeFileSync(join(workflowDir, "PROJECT.md"), FIXTURE_PROJECT_MD);
  writeFileSync(join(workflowDir, "STATE.md"), FIXTURE_STATE_MD);

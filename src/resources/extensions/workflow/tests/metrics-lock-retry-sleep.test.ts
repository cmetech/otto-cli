// the agent + metrics-lock-retry-sleep.test.ts: verify sleep between lock acquire retries (M3 follow-up)
/**
...
const holdMs = parseInt(process.env.OTTO_TEST_HOLD_MS || '100', 10);

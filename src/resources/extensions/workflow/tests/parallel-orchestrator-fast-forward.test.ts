...
describe("_createMilestoneWorktree fast-forwards reused milestone branches (#5549 R3)", () => {
  ...
  beforeEach(() => {
    ...
    // Minimal .otto/workflow/ structure so syncWorkflowStateToWorktree doesn't crash on a
  ...
  test("reused milestone branch behind main is fast-forwarded before worktree creation", () => {
    ...
    // _createMilestoneWorktree may throw inside createWorktree/syncWorkflowStateToWorktree

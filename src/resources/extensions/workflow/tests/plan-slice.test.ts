...
import { openDatabase, closeDatabase, insertMilestone, insertSlice, getSlice, getSliceTasks, getTask, getGateResults, updateTaskStatus } from '../db.ts';
    ...
    tasks: [
      {
        ...
        estimate: '45m',
        files: ['src/resources/extensions/workflow/tools/plan-slice.ts'],
        verify: 'node --test src/resources/extensions/workflow/tests/plan-slice.test.ts',
        inputs: ['src/resources/extensions/workflow/tools/plan-milestone.ts'],
        expectedOutput: ['src/resources/extensions/workflow/tools/plan-slice.ts'],
      ...
      },
      {
        ...
        estimate: '30m',
        files: ['src/resources/extensions/workflow/tools/plan-task.ts'],
        verify: 'node --test src/resources/extensions/workflow/tests/plan-task.test.ts',
        inputs: ['src/resources/extensions/workflow/tools/plan-task.ts'],
        expectedOutput: ['src/resources/extensions/workflow/tests/plan-task.test.ts'],

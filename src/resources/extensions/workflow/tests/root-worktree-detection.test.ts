...
import { workflowProjectionRoot, workflowRoot, resolveWorkflowPathContract, _clearWorkflowRootCache } from "../paths.ts";

describe("workflowRoot() worktree detection (#2594)", () => {

...
describe('shared-wal', async () => {
  ...
  console.log('\n=== shared-wal: resolve worktree path to project root DB ===');
  {
    ...
    const worktreePath = join(projectRoot, '.otto/workflow', 'worktrees', 'M001');
    const result = resolveProjectRootDbPath(worktreePath);
    assert.deepStrictEqual(result, join(projectRoot, '.otto/workflow', 'otto.db'),
  ...
  {
    const projectRoot = '/home/user/myproject';
    const nestedPath = join(projectRoot, '.otto/workflow', 'worktrees', 'M002', 'src', 'lib');
  ...
  {
    const result = resolveProjectRootDbPath('/proj/.otto/workflow/worktrees/M001');
    assert.deepStrictEqual(result, join('/proj', '.otto/workflow', 'otto.db'),
  ...
  {
    // External-state layout: ~/.otto/workflow/projects/<hash>/worktrees/<MID>
    // Should resolve to:     ~/.otto/workflow/projects/<hash>/otto.db
    const stateRoot = '/home/user/.otto/workflow/projects/a1b2c3d4';
    const worktreePath = join(stateRoot, 'worktrees', 'M002');
    const result = resolveProjectRootDbPath(worktreePath);
    assert.deepStrictEqual(result, join(stateRoot, 'otto.db'),
  ...
  {
    const stateRoot = '/home/user/.otto/workflow/projects/deadbeef42';
  ...
  {
    const result = resolveProjectRootDbPath('/Users/dev/.otto/workflow/projects/cafe0123/worktrees/M001');
    assert.deepStrictEqual(result, join('/Users/dev/.otto/workflow/projects/cafe0123', 'otto.db'),

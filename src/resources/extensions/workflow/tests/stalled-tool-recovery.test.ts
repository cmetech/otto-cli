...

{
  ...
  // basePath is undefined, which causes join(undefined, ".otto/workflow") to throw.
...

{
  ...
  try {
    ...
    const runtime = JSON.parse(readFileSync(join(base, ".otto/workflow", "runtime", "units", "execute-task-M001-S01-T01.json"), "utf-8"));
...

{
  ...
  mkdirSync(join(base, ".otto/workflow", "milestones", "M001", "slices", "S01", "tasks"), { recursive: true });
  mkdirSync(join(base, ".otto/workflow", "runtime", "units"), { recursive: true });

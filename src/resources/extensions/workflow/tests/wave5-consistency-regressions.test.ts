// Workflow State Machine — Wave 5 Consistency Regression Tests
...
import { openDatabase, closeDatabase, upsertDecision, _getAdapter, insertMilestone, insertSlice, insertTask, getTask } from "../db.js";
...
describe("WorkflowEvent v field", () => {
  test("appendEvent includes v:2 in output", async () => {
    ...
    try {
      ...
      const logPath = join(tmp, ".otto/workflow", "event-log.jsonl");

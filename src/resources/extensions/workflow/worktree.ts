 ...
 * Returns null if not inside a workflow worktree (.gsd/worktrees/<name>/).
 */
 ...
 *
 * When `/.gsd/` in the resolved path is actually the user-level `~/.otto/`
 * (common when `.gsd` is a symlink into `~/.otto/projects/<hash>`), the

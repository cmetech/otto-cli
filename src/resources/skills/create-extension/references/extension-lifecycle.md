...
<loading>
Extensions load when OTTO starts (or on `/reload`). The default export function runs synchronously — subscribe to events and register tools/commands during this call.

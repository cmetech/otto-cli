...
- Append to `.otto/workflow/DECISIONS.md` with the chosen shape and the reason.
...
- [ ] The decision is captured in `.otto/workflow/DECISIONS.md` or the active `S##-CONTEXT.md`.

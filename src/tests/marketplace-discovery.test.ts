...
import {
  ...
  discoverMarketplace,
  resolvePluginRoot
} from '../resources/extensions/workflow/marketplace-discovery.js';
import { getMarketplaceFixtures } from '../resources/extensions/workflow/tests/marketplace-test-fixtures.js';
